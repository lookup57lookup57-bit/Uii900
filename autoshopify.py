...
# SINGLE Flask app instance - ONLY ONE!
app = Flask(__name__)

# Then all your QUERY variables (QUERY_PROPOSAL_SHIPPING, etc.)
QUERY_PROPOSAL_SHIPPING = """..."""
QUERY_PROPOSAL_DELIVERY = """..."""
MUTATION_SUBMIT = """..."""
QUERY_POLL = """..."""

# Then all your dictionaries (C2C, book)
C2C = {...}
book = {...}

# Then all your functions (pick_addr, capture, extract_between, Utils, etc.)
...
# Then at the VERY BOTTOM - the main block
